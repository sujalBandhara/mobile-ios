...
public class ACTabScrollView: UIView, UIScrollViewDelegate {
    ...
    @IBInspectable public var tabSectionBackgroundColor: UIColor = UIColor.clearColor()
                    ...
                    if let tab = self.cachedPageTabs[i] {
                        if (animated) {
                            UIView.animateWithDuration(0.5, delay: 0, options: UIViewAnimationOptions.AllowUserInteraction, animations: {
                                ...
                                if alpha == 1.0
                                {
                                   // tab.backgroundColor = UIColor(red: 0.0 / 255, green:  0.0 / 255, blue: 0.0 / 255, alpha: 0.3)
                                    tab.backgroundColor = UIColor(red: 44.0/255.0, green: 38.0/255.0, blue: 67.0/255.0, alpha: 0.8)
                                    if let lbl = tab as? UILabel
                                    {
                                        lbl.textColor = UIColor.whiteColor()
                                    }
                                    //tab.backgroundColor = UIColor(red: 49.0 / 255, green: 101.0 / 255, blue: 210.0 / 255, alpha: 1.0)
                                    //UIColor.init(colorLiteralRed: 44.0/255.0, green: 38.0/255.0, blue: 67.0/255.0, alpha: 0.8))
                                }
                                else
                                {
