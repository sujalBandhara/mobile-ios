...
class DOAlertController : UIViewController, UITextFieldDelegate, UIViewControllerTransitioningDelegate {
    ...
    private var buttonMargin: CGFloat = 5.0
    ...
    var buttonFont: [DOAlertActionStyle : UIFont!] = [
        ...
        .Destructive  : UIFont(name: "HelveticaNeue-Light", size: 16)
    ]
    var buttonTextColor: [DOAlertActionStyle : UIColor] = [
        .Default : UIColor(red:0/255, green:122/255, blue:255/255, alpha:1),
        .Cancel  : UIColor(red:0/255, green:122/255, blue:255/255, alpha:1),
        .Destructive  : UIColor(red:208/255, green:2/255, blue:27/255, alpha:1)
    ]
    ////UIColor(red:208/255, green:2/255, blue:27/255, alpha:1),
    ...
    private var buttonCornerRadius: CGFloat = 2.0
