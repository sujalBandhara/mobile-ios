...
static CGFloat kBGColorAlphaMax = 0.7;
...
+ (void)showWithView:(UIView *)view style:(JTProgressHUDStyle)style transition:(JTProgressHUDTransition)transition backgroundAlpha:(CGFloat)backgroundAlpha {
    ...
    // Properties
    sharedInstance.styleColor1 = [[UIColor whiteColor] colorWithAlphaComponent:backgroundAlpha - kBGColorAlphaSkip];
    sharedInstance.styleColor2 = [[UIColor lightGrayColor] colorWithAlphaComponent:backgroundAlpha];
