...
//    }
    ...
    private let placeholderInsets = CGPoint(x: 4, y: 6)
    ...
    override public func drawViewsForRect(rect: CGRect) {
        ...
        placeholderLabel.font = placeholderFontFromFont(placeholderLabel.font!)
    ...
    override public func animateViewsForTextDisplay() {
        if text!.isEmpty {
            ...
            UIView.animateWithDuration(0.3, animations: {
                ...
                var fontSize : Float  = Float(self.placeholderLabel.font.pointSize)
                fontSize = 10
                self.placeholderLabel.font = UIFont(name: self.placeholderLabel.font.fontName, size: CGFloat(fontSize))
            }) { _ in
